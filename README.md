...
3. Termux-X11 App: This application acts as the display server (your monitor) to show the Linux desktop. Note: Termux-X11 is no longer available on F-Droid. You must download the official Companion APK (app-arm64-v8a-debug.apk) directly from their GitHub releases page:
...
```
curl -O https://raw.githubusercontent.com/cloudaii/termux-linux-setup/main/termux-linux-setup.sh && chmod +x termux-linux-setup.sh && ./termux-linux-setup.sh
```
